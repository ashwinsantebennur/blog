...
RSpec.describe Post, type: :model do
  ...
  it "is valid with valid attributes" do
    post = Post.new(title: "Anything", body: "Something", author: user)
    expect(post).to be_valid
  end

  # Example of an invalid post (missing title)
  it "is not valid without a title" do
    post = Post.new(body: "Something", author: user)
    expect(post).to_not be_valid
  end

  # Example of an invalid post (missing body)
  it "is not valid without a body" do
    post = Post.new(title: "Something", author: user)
    expect(post).to_not be_valid
  end

  # Check for uniqueness of title
  subject { described_class.new(title: "An existing title", body: "Some content", author: user) }

  context 'when the title is not unique' do
    before { described_class.create!(title: "An existing title", body: "Other content", author: user) }
  ...
  context 'when the title is unique' do
    before { described_class.create!(title: "A different title", body: "Other content", author: user) }
